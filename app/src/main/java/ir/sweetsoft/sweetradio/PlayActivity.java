...
public class PlayActivity extends Activity implements IVLCVout.Callback {
...
try {
    ...
    private static class MyPlayerListener implements MediaPlayer.EventListener {
        private WeakReference<PlayActivity> mOwner;

        public MyPlayerListener(PlayActivity owner) {
            mOwner = new WeakReference<PlayActivity>(owner);
        }

        @Override
        public void onEvent(MediaPlayer.Event event) {
            PlayActivity player = mOwner.get();
